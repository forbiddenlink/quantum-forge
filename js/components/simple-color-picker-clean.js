...
class SimpleColorPicker extends HTMLElement {
    ...
    createPanel() {
        ...
        const colors = [
            ...
            { color: '#06b6d4', name: 'Cyan', desc: 'Fresh & Modern' },
            { color: '#10b981', name: 'Emerald', desc: 'Growth & Success' },
            { color: '#84cc16', name: 'Lime', desc: 'Energy & Nature' },
            { color: '#f59e0b', name: 'Amber', desc: 'Warmth & Creativity' },
            { color: '#ef4444', name: 'Red', desc: 'Bold & Dynamic' },
            { color: '#ec4899', name: 'Pink', desc: 'Playful & Creative' },
            { color: '#8b5cf6', name: 'Violet', desc: 'Luxury & Innovation' },
            { color: '#64748b', name: 'Slate', desc: 'Minimal & Clean' },
            { color: '#dc2626', name: 'Crimson', desc: 'Power & Passion' },
            { color: '#7c3aed', name: 'Purple', desc: 'Royal & Sophisticated' }
        ];
