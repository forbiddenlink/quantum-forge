...
### Rule Content:
```css
50% { transform: scale(1.003) translateZ(3px); }
```
...
- team.css:967 (.activity-icon svg)
...
- team.css:1464 (.enhanced-team-spotlight)
